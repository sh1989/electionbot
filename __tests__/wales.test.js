...
beforeAll(() => {
  tableScraper.setMock([[
    { 'Con': 40, 'Lab': 30, 'PC': 13, 'LD': 8, 'UKIP': 6, 'Grn': 2 },
    { 'Con': 28, 'Lab': 33, 'PC': 13, 'LD': 9, 'UKIP': 13, 'Grn': 2 },
    { 'Con': 29, 'Lab': 35, 'PC': 13, 'LD': 7, 'UKIP': 14, 'Grn': 2 },
    { 'Con': 23, 'Lab': 34, 'PC': 16, 'LD': 8, 'UKIP': 16, 'Grn': 2 },
    { 'Con': 22, 'Lab': 39, 'PC': 14, 'LD': 6, 'UKIP': 18 , 'Grn': 2},
    { 'Con': 23, 'Lab': 37, 'PC': 13, 'LD': 7, 'UKIP': 17, 'Grn': 2 },
    { 'Con': 22, 'Lab': 38, 'PC': 13, 'LD': 6, 'UKIP': 18, 'Grn': 2 },
    { 'Con': 25, 'Lab': 36, 'PC': 14, 'LD': 6, 'UKIP': 16, 'Grn': 0 }
  ]]);
});
